...
public record ASTVarAssignment(ASTVar variable, SourceRange operatorRange, ASTNode value, SourceRange range) implements ASTNode {
    @Override
    public List<HighlightData> highlightData() {
        List<HighlightData> highlights = new ArrayList<>();
        if (variable != null) highlights.addAll(variable.highlightData());
