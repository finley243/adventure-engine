...
public record ASTWorldRef(SourceRange keywordRange, SourceRange nameRange, String name, SourceRange range) implements ASTNode {
    @Override
    public List<HighlightData> highlightData() {
        List<HighlightData> highlights = new ArrayList<>();
        highlights.add(new HighlightData(HighlightType.KEYWORD, keywordRange));
        highlights.add(new HighlightData(HighlightType.MEMBER_NAME, nameRange));
        return highlights;
    }
}
