...
public class EffectLoader {
    ...
    public EffectLoader(ScriptParser scriptParser) {
    ...
    private Effect parseEffect(Element element) {
        ...
        Condition conditionAdd = LoadUtils.loadCondition(LoadUtils.singleChildWithName(element, "conditionAdd"), scriptParser, "Effect(" + ID + ") - add condition");
        Condition conditionRemove = LoadUtils.loadCondition(LoadUtils.singleChildWithName(element, "conditionRemove"), scriptParser, "Effect(" + ID + ") - remove condition");
        Condition conditionActive = LoadUtils.loadCondition(LoadUtils.singleChildWithName(element, "conditionActive"), scriptParser, "Effect(" + ID + ") - active condition");
        ...
        switch (effectType) {
            case "add" -> {
                ...
                Condition statCondition = LoadUtils.loadCondition(LoadUtils.singleChildWithName(element, "statCondition"), scriptParser, "Effect(" + ID + ") - stat condition");
