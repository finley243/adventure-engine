...
public abstract class Script {
	...
	public static void loadBuiltInFunctions(Game game) {
		...
		functions.add(new ScriptParser.ScriptData("isCombatant", null, List.of(new ScriptParser.ScriptParameter("actor", true, null), new ScriptParser.ScriptParameter("target", true, null)), false, new ScriptIsCombatant()));
		functions.add(new ScriptParser.ScriptData("isVisible", null, List.of(new ScriptParser.ScriptParameter("actor", true, null), new ScriptParser.ScriptParameter("target", true, null)), false, new ScriptIsVisible()));
		functions.add(new ScriptParser.ScriptData("randomBoolean", null, List.of(new ScriptParser.ScriptParameter("chance", true, null)), false, new ScriptRandomBoolean()));
		functions.add(new ScriptParser.ScriptData("inventoryContains", null, List.of(new ScriptParser.ScriptParameter("inventory", true, null), new ScriptParser.ScriptParameter("item", true, null), new ScriptParser.ScriptParameter("requireAll", false, Expression.constant(false))), false, new ScriptInventoryContains()));
		functions.add(new ScriptParser.ScriptData("round", null, List.of(new ScriptParser.ScriptParameter("value", true, null)), false, new ScriptRound()));
		functions.add(new ScriptParser.ScriptData("scaleLinear", null, List.of(new ScriptParser.ScriptParameter("input", true, null), new ScriptParser.ScriptParameter("inputMin", true, null), new ScriptParser.ScriptParameter("inputMax", true, null), new ScriptParser.ScriptParameter("outputMin", true, null), new ScriptParser.ScriptParameter("outputMax", true, null)), false, new ScriptScaleLinear()));
		functions.add(new ScriptParser.ScriptData("scaleLog", null, List.of(new ScriptParser.ScriptParameter("input", true, null), new ScriptParser.ScriptParameter("inputMin", true, null), new ScriptParser.ScriptParameter("inputMax", true, null), new ScriptParser.ScriptParameter("outputMin", true, null), new ScriptParser.ScriptParameter("outputMax", true, null)), false, new ScriptScaleLog()));
		functions.add(new ScriptParser.ScriptData("setContains", null, List.of(new ScriptParser.ScriptParameter("set", true, null), new ScriptParser.ScriptParameter("value", true, null)), false, new ScriptSetContains()));
		functions.add(new ScriptParser.ScriptData("setSize", null, List.of(new ScriptParser.ScriptParameter("set", true, null)), false, new ScriptSetSize()));
