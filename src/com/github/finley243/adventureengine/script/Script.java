...
public abstract class Script {
	...
	public static void loadNativeFunctions(Game game) {
		...
		functions.add(new ScriptParser.ScriptData("setClear", false, null, List.of(new ScriptParser.ScriptParameter("set", true, null)), false, new ScriptSetClear()));
		functions.add(new ScriptParser.ScriptData("setCopy", true, Expression.DataType.SET, List.of(new ScriptParser.ScriptParameter("set", true, null)), false, new ScriptSetCopy()));
		functions.add(new ScriptParser.ScriptData("setUnion", true, Expression.DataType.SET, List.of(new ScriptParser.ScriptParameter("setOne", true, null), new ScriptParser.ScriptParameter("setTwo", true, null)), false, new ScriptSetUnion()));
		functions.add(new ScriptParser.ScriptData("setIntersect", true, Expression.DataType.SET, List.of(new ScriptParser.ScriptParameter("setOne", true, null), new ScriptParser.ScriptParameter("setTwo", true, null)), false, new ScriptSetIntersect()));
		functions.add(new ScriptParser.ScriptData("setDifference", true, Expression.DataType.SET, List.of(new ScriptParser.ScriptParameter("setOne", true, null), new ScriptParser.ScriptParameter("setTwo", true, null)), false, new ScriptSetDifference()));
		functions.add(new ScriptParser.ScriptData("setSymmetricDifference", true, Expression.DataType.SET, List.of(new ScriptParser.ScriptParameter("setOne", true, null), new ScriptParser.ScriptParameter("setTwo", true, null)), false, new ScriptSetSymmetricDifference()));
		...
		functions.add(new ScriptParser.ScriptData("listIndexOf", false, null, List.of(new ScriptParser.ScriptParameter("list", true, null), new ScriptParser.ScriptParameter("value", true, null)), false, new ScriptListIndexOf()));
		...
		functions.add(new ScriptParser.ScriptData("listClear", false, null, List.of(new ScriptParser.ScriptParameter("list", true, null)), false, new ScriptListClear()));
		functions.add(new ScriptParser.ScriptData("listCopy", true, Expression.DataType.LIST, List.of(new ScriptParser.ScriptParameter("list", true, null)), false, new ScriptListCopy()));
		functions.add(new ScriptParser.ScriptData("subList", true, Expression.DataType.LIST, List.of(new ScriptParser.ScriptParameter("list", true, null), new ScriptParser.ScriptParameter("start", true, null), new ScriptParser.ScriptParameter("end", true, null)), false, new ScriptSubList()));
		functions.add(new ScriptParser.ScriptData("listConcat", true, Expression.DataType.LIST, List.of(new ScriptParser.ScriptParameter("listOne", true, null), new ScriptParser.ScriptParameter("listTwo", true, null)), false, new ScriptListConcat()));
		functions.add(new ScriptParser.ScriptData("randomFromList", true, null, List.of(new ScriptParser.ScriptParameter("list", true, null)), false, new ScriptRandomValueFromList()));
