...
public class ScriptSetContains extends Script {
    ...
    public ScriptReturnData execute(Context context) {
        ...
        if (valueExpression.getDataType() != Expression.DataType.STRING) return new ScriptReturnData(null, false, false, "Value parameter is not a string");
        ...
        return new ScriptReturnData(Expression.constant(setContainsValue), false, false, null);
    }
