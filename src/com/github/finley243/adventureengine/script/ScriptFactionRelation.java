...
public class ScriptFactionRelation extends Script {
	...
	public ScriptFactionRelation(Condition condition, Map<String, Variable> localParameters, String targetFaction, String relationFaction, FactionRelation relation) {
