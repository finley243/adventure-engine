...
public class ScriptTimerActive extends Script {
    ...
    public ScriptTimerActive(int line) {
        super(line);
    }
    ...
    public ScriptReturnData execute(Context context) {
        ...
        if (timerID.getDataType() != Expression.DataType.STRING) return new ScriptReturnData(null, null, new ScriptErrorData("Timer parameter is not a string", getLine()));
