...
public class ScriptRound extends Script {
    ...
    public Script.ScriptReturnData execute(Context context) {
        ...
        if (valueExpression.getDataType() != Expression.DataType.FLOAT) return new Script.ScriptReturnData(null, null, new ScriptErrorData("Value parameter is not a float", -1));
