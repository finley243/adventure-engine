...
public abstract class ActionAttack extends ActionRandomEach<AttackTarget> {
    ...
    public void onSuccess(Actor subject, AttackTarget target, int repeatActionCount) {
        ...
        subject.game().eventQueue().addToEnd(new SensoryEvent(subject.getArea(), Phrases.get(getHitPhrase(repeatActionCount)), Phrases.get(getHitPhraseAudible(repeatActionCount)), attackContext, true, isLoud, null, null, subject, (target instanceof Actor ? (Actor) target : null)));
    ...
    public void onFail(Actor subject, AttackTarget target, int repeatActionCount) {
        TextContext attackContext = new TextContext(Map.of("limb", (getLimb() == null ? "null" : getLimb().getName()), "relativeTo", (getArea() == null ? "null" : getArea().getRelativeName())), new MapBuilder<String, Noun>().put("actor", subject).put("target", (Noun) target).put("weapon", getWeapon()).putIf(getArea() != null, "area", getArea()).build());
        subject.game().eventQueue().addToEnd(new SensoryEvent(subject.getArea(), Phrases.get(getMissPhrase(repeatActionCount)), Phrases.get(getMissPhraseAudible(repeatActionCount)), attackContext, true, isLoud, null, null, subject, (target instanceof Actor ? (Actor) target : null)));
    ...
    public void onSuccessOverall(Actor subject, int repeatActionCount) {
        ...
        subject.game().eventQueue().addToEnd(new SensoryEvent(subject.getArea(), Phrases.get(getHitOverallPhrase(repeatActionCount)), Phrases.get(getHitOverallPhraseAudible(repeatActionCount)), attackContext, true, isLoud, this, null, subject, null));
    }

    @Override
    public void onFailOverall(Actor subject, int repeatActionCount) {
        TextContext attackContext = new TextContext(Map.of("limb", (getLimb() == null ? "null" : getLimb().getName()), "relativeTo", (getArea() == null ? "null" : getArea().getRelativeName())), new MapBuilder<String, Noun>().put("actor", subject).put("weapon", getWeapon()).putIf(getArea() != null, "area", getArea()).build());
        subject.game().eventQueue().addToEnd(new SensoryEvent(subject.getArea(), Phrases.get(getMissOverallPhrase(repeatActionCount)), Phrases.get(getMissOverallPhraseAudible(repeatActionCount)), attackContext, true, isLoud, this, null, subject, null));
    }
