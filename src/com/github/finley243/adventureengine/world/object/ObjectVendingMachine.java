...
public class ObjectVendingMachine extends WorldObject {
	...
	public ObjectVendingMachine(Game game, String ID, Area area, String name, Scene description, Map<String, Script> scripts, List<ActionCustom> customActions, List<String> vendingItems) {
