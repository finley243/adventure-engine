...
public class WeaponTemplate extends EquippableTemplate {
	...
	public WeaponTemplate(Game game, String ID, String name, Scene description, Map<String, Script> scripts, List<ItemComponentTemplate> components, List<ActionCustom.CustomActionHolder> customActions, int price, List<String> equippedEffects, List<ActionCustom.CustomActionHolder> equippedActions, String weaponClass, int damage, int rate, int critDamage, float critChance, int clipSize, int reloadActionPoints, float armorMult, boolean silenced, String damageType, Set<String> targetEffects, Map<String, Integer> modSlots) {
		super(game, ID, name, description, scripts, components, customActions, price, null, equippedEffects, equippedActions);
