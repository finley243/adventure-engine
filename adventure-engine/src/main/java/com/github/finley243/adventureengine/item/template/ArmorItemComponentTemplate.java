...
public class ArmorItemComponentTemplate extends ItemComponentTemplate {
    ...
    public ArmorItemComponentTemplate(boolean actionsRestricted, Map<String, Integer> damageResistance, Map<String, Float> damageMult, Set<String> coveredLimbs, boolean coversMainBody) {
