...
public class InventoryObjectComponentTemplate extends ObjectComponentTemplate {
    ...
    public InventoryObjectComponentTemplate(boolean startEnabled, boolean actionsRestricted, LootTable lootTable, String takePrompt, String takePhrase, String storePrompt, String storePhrase, boolean enableTake, boolean enableStore, List<ActionCustom.CustomActionHolder> perItemActions) {
