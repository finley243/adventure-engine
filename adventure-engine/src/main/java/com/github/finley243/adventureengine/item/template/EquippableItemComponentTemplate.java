...
public class EquippableItemComponentTemplate extends ItemComponentTemplate {

    private final Set<EquippableSlotsData> slots;

    public EquippableItemComponentTemplate(boolean actionsRestricted, Set<EquippableSlotsData> slots) {
