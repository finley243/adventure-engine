...
public class UsableObjectComponentTemplate extends ObjectComponentTemplate {

    private Map<String, UsableSlotData> usableSlotData;

    public UsableObjectComponentTemplate(boolean startEnabled, boolean actionsRestricted, Map<String, UsableSlotData> usableSlotData) {
